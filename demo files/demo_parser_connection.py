"""File contains a demonstration of how to parse connections."""
...
scanner_1 = Scanner("demo_con.txt", names_1)

list_of_symbols_1 = scanner_1.get_list_of_symbols()

print("Contents of demo_con.txt")
...
# Check Parser.connection(), Parser.connection_list()
parser_1 = Parser(names_1, device_1, network_1, monitor_1, scanner_1)
print(parser_1.connection_list())
