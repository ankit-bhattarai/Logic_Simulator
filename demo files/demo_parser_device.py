"""File contains a demonstration of how to parse devices."""
...
scanner_1 = Scanner("demo_dev.txt", names_1)

list_of_symbols_1 = scanner_1.get_list_of_symbols()

print("Contents of demo_dev.txt")
...
# Check Parser.device(), Parser.device_list()
parser_1 = Parser(names_1, device_1, network_1, monitor_1, scanner_1)
print(parser_1.device_list())
